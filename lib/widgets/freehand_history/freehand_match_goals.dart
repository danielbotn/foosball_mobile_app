    ...
    return Padding(
      ...
      child: Container(
        ...
        itemBuilder: (context, index) {
          String score = freehandGoals![index].scoredByScore.toString() + "-" + freehandGoals![index].oponentScore.toString();
          String scoredByName = freehandGoals![index].scoredByUserFirstName + " " + freehandGoals![index].scoredByUserLastName;
